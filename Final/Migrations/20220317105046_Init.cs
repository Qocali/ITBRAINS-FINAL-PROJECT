        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Start = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: DateTime.UtcNow.AddHours(4)),
                    Finish = table.Column<DateTime>(type: "datetime2", nullable: true, defaultValue: DateTime.UtcNow.AddHours(4)),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Scills = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CourseCatigoriesId = table.Column<int>(type: "int", nullable: false),
                    IsDeactive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Teacher_Professions_ProfessionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubTitle = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    STARTS = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: DateTime.UtcNow.AddHours(4)),
                    DURATION = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValue: DateTime.UtcNow.AddHours(4)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SocialMedias_Teacher_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Scype = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TeacherId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherSkillsmany", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TeacherSkillsmany_Teacher_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teacher",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherSkillsmany_TeacherSkills_TeacherSkillsId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "https://www.facebook.com/qocheli.babayev", "logo.png", "https://www.Pinterest.com/in/qocheli-babayev-141009218", "https://www.linkedin.com/in/qocheli-babayev-141009218", "https://www.Vimeo.com/qocheli.babayev" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherSkillsmany_TeacherId",
                table: "TeacherSkillsmany",
                column: "TeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherSkillsmany_TeacherSkillsId",
                table: "TeacherSkillsmany",
